  ...
  .factory('Light', function ($http) {
    ...
    return {
      opt: function (device_sn, md_code, md_value) {
        ...
        var req = {
          method: 'POST',
          url: 'http://123.57.90.89/opencenter/api.php?s=/devices/asyncommand',
          data: {
            "device_sn":device_sn,
            "md_code":md_code,
            "md_value":md_value
  ...
  .factory('Devices', function ($http) {
    ...
    return {
      ...
      get: function (deviceId) {
        var req = {
          method: 'POST',
          url: 'http://123.57.90.89/opencenter/api.php?s=/devices/5',
          headers: {
            'Authorization': 'Token ' + localStorage["token"] + ''
          }
        }
      ...
      status: function (sn, code) {
        ...
        var req = {
          method: 'GET',
          url: 'http://123.57.90.89/opencenter/api.php?s=/devices/' + sn + '/' + code + '',
          headers: {
            'Authorization': 'Token ' + localStorage["token"] + ''
          }
        }
      ...
      auth: function (sn, uid, authtype) {
        ...
        var req = {
          method: 'POST',
          url: 'http://123.57.90.89/opencenter/api.php?s=/devices/auth',
          data: {
            "device_sn": sn, //"82NTESTMAC",
  ...
  .factory('Message', function ($http) {
    return {
      get: function (id) {
        var req = {
          method: 'GET',
          url: 'http://123.57.90.89/opencenter/api.php?s=message/get/30',
          headers: {
            'Authorization': 'Token ' + localStorage["token"] + ''
          }
        }
      ...
      all: function (u, p) {
        var req = {
          method: 'GET',
          url: 'http://123.57.90.89/opencenter/api.php?s=message/list',
          headers: {
            'Authorization': 'Token ' + localStorage["token"] + ''
          }
        }
  ...
  .factory('Account', function ($http) {
    return {
      get: function (id) {
        var req = {
          method: 'GET',
          url: 'http://123.57.90.89/opencenter/api.php?s=users/profile/' + id,
          headers: {
            'Authorization': 'Token ' + localStorage["token"] + ''
          }
        }
      ...
      login: function (u, p) {
        var req = {
          method: 'POST',
          url: 'http://123.57.90.89/opencenter/api.php?s=/users/login',
      ...
      reg: function (u, p) {
        var req = {
          method: 'POST',
          url: 'http://123.57.90.89/opencenter/api.php?s=/users/reg',
          data: {username: u, password: p},
          headers: {
            'Authorization': 'Token ' + localStorage["token"] + ''
          }
  ...
  .factory('Version', function ($http) {
    ...
    return {
      get: function () {
        ...
        return $http({
          method: 'GET',
          url: 'http://123.57.90.89/opencenter/api.php?s=/system/appversion/ios/smartappliance',
          headers: {
            'Authorization': 'Token 1af538baa9045a84c0e889f672baf83ff24'
          }
        });
  ...
  .factory('Chats', function ($http) {
    ...
    return {
      ...
      get: function (id) {
        var req = {
          method: 'GET',
          url: 'http://123.57.90.89/opencenter/api.php?s=/message/get/' + id,
          headers: {
            'Authorization': 'Token ' + localStorage["token"] + ''
          }
        }
